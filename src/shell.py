...
PAGES = [
    ...
    ("10-chat-internals.html", "聊天模型内部", "第三部分 · 内部源码"),
    ("11-tool-internals.html", "工具调用内部", "第三部分 · 内部源码"),
...
def index_page(standalone=False):
    ...
    subtitles = {
        ...
        "09-runnable-compose.html": "Sequence / Parallel 组合",
        "10-chat-internals.html": "BaseChatModel 调用链",
        "11-tool-internals.html": "函数 → JSON Schema → tool_calls",
