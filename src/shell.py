...
PAGES = [
    ...
    ("13-agent-internals.html", "Agent 内部", "迁移中 · 内部源码"),
    ("15-contributing.html", "读源码 / 调试 / 测试 / 贡献", "迁移中 · 工程旧版"),
    ("17-rag.html", "RAG 检索增强", "迁移中 · Agent/RAG 旧版"),
    ("18-custom-middleware.html", "写自己的中间件", "迁移中 · Agent/RAG 旧版"),
    ("19-runtime-context.html", "运行时上下文与健壮性", "迁移中 · Agent/RAG 旧版"),
    ("20-capstone.html", "端到端实战：拼一个客服 Agent", "迁移中 · Agent/RAG 旧版"),
