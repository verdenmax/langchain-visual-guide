    ...
    "05-chat-models.html": {
        "mcq": [
            ...
            },
            {
                ...
                "answer": 1,
                "why": "一套接口、多种执行语义，是 Runnable 抽象的红利（第 10 课）——换场景只换方法名，不换世界观。",
            },
            {
    ...
    "06-tools.html": {
        "mcq": [
            ...
            },
            {
                ...
                "answer": 1,
                "why": "把异常变成“对话里的一条反馈”，闭环就从“崩溃”变成“纠正”。这是 Agent 鲁棒性的重要来源（第 14 课看实现）。",
            },
        ],
        "open": [
        ...
        "mcq": [
            {
                ...
                "answer": 1,
                "why": "“把会变的（内容）和不变的（结构）分开”是模板的通用价值——和第 8 课“代码自描述”、第 3 课“中间表示”一样，都是隔离变化点。",
            },
            {
                ...
                "answer": 1,
                "why": "呼应第 6 课——消息的结构化是有意义的。MessagesPlaceholder 保住了这份结构，而不是把它压扁成字符串。",
            },
            {
