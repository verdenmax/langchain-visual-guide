...
<div class="card detail">
  ...
  <ul>
    <li><strong>看真实请求</strong>：给 <span class="mono">invoke</span> 传一个打印型回调（<span class="mono">config={"callbacks":[...]}</span>，见第 13 课），
...
<div class="card key">
  ...
  <ul>
    ...
    <li>🎉 <strong>恭喜！你已经从零走完了 LangChain 的宏观与细节。</strong>现在去读真实源码、动手改一处试试吧。</li>
  </ul>
</div>
"""
