...
<table class="t">
  ...
  <tr><td class="mono">checkpointer / Checkpoint / thread_id</td><td>每超步存档，按 thread_id 区分会话、可续跑</td><td><a href="26-langgraph-persistence-control.html">Checkpoint 与持久化</a></td></tr>
  <tr><td class="mono">StateSnapshot / 时间旅行</td><td>某步的状态快照；可回到历史 checkpoint 重跑</td><td><a href="34-langgraph-time-travel-debug.html">时间旅行、回放与调试</a></td></tr>
  <tr><td class="mono">interrupt / 人在回路（HITL）</td><td>在节点里暂停等人，Command(resume) 恢复</td><td><a href="33-langgraph-interrupt-command.html">interrupt、Command 与人在回路</a></td></tr>
  <tr><td class="mono">Send</td><td>动态扇出：把多个任务并行投给同一节点（并行工具）</td><td><a href="32-langgraph-tasks-channels.html">Tasks、Channels 与调度</a></td></tr>
  <tr><td class="mono">Command</td><td>改状态 + 跳转（goto）；多 Agent handoff 的底座</td><td><a href="33-langgraph-interrupt-command.html">interrupt、Command 与人在回路</a></td></tr>
...
<table class="t">
  ...
  <tr><td class="mono">handoff（交接）</td><td>一个 Agent 把任务交棒给另一个</td><td><a href="33-langgraph-interrupt-command.html">interrupt、Command 与人在回路</a></td></tr>
