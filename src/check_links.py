...
Checks index.html and lessons/*.html: each relative href ending in .html
must point to an existing file (resolved relative to the page's directory).
External (http), anchors (#) and the generated PDF are skipped.
...
ALLOW_MISSING = {"langchain-visual-guide.pdf"}
