...
<details class="accordion">
  ...
  <div class="acc-body">
    <div class="qa">
      ...
      <div class="a">
<pre class="code"><span class="kw">from</span> langchain.agents.middleware <span class="kw">import</span> ModelCallLimitMiddleware

agent = create_agent(model, tools, middleware=[
    ModelCallLimitMiddleware(max_calls=8),   <span class="cm"># 业务级：最多调 8 次模型</span>
])
